...
features = ["title_length", "has_number", "has_punctuation", "upper_word_count", "day_of_week", "hour", "duration_seconds"]
...
print(importances.to_string())
 ...
 # XGBOOST
xg = XGBClassifier(n_estimators=100, random_state=42, scale_pos_weight= (y_train == 0).sum() / (y_train == 1).sum())
